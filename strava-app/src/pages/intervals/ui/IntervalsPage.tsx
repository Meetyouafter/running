...
import { paceSecToStr, fmt } from '@/shared/lib';
import { MultiLineChart, LineChart } from '@/shared/ui';
import { fetchICUData } from '../api/icu';
import styles from './IntervalsPage.module.css';
